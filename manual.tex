...
使用 \hologo{XeLaTeX}\ 编译时，会自动在中英文转换时添加必要的空格。 使用 [PDF]\LaTeX\
...
可以看出，以上两行用 \hologo{XeLaTeX}\ 编译的结果是相同的。
...
后来 PDF 格式成为主流，pdf\TeX、DVIPDFM、DVIPDFMx、\hologo{XeTeX}\ 等工具则主要支持 PDF、PNG、JPG 格式的图形，
...
天元系统，到后来的 CJK 方式，到近来的 \hologo{XeTeX}、LuaTeX 方式，
