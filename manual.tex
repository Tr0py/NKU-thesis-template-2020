...
\section{南开大学学位论文格式宏包 NKThesis 使用说明} \label{chpt:A}
...
引用章节号请参考如下格式: 第\ref{chpt:A}章第\ref{sec:ex:A}节或\autoref{chpt:A}\autoref{sec:ex:A}
...
\subsubsection{什么是 \TeX/\LaTeX，我是否应该选择它}
...
参考文献的录入请参考第\ref{chpt:A}章第\ref{manual:ref}节。 